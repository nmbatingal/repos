...
<head>
    ...
    <!-- bootstrap -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/assets/css/bootstrap.min.css') }}">
    <!-- themify-icon.css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/assets/css/themify-icons.css') }}">
    <!-- owl-carousel -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/assets/css/owl.carousel.css') }}">
    <!-- Video-min -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/assets/css/video.min.css') }}">
    <!-- animate.css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/assets/css/animate.css') }}">
    <!-- REVOLUTION STYLE SHEETS -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/rev-slider/css/settings.css') }}">
    <!-- REVOLUTION LAYERS STYLES -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/rev-slider/css/layers.css') }}">
    <!-- REVOLUTION NAVIGATION STYLES -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/rev-slider/css/navigation.css') }}">
    <!-- menu style -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/assets/css/menu.css') }}">
    <!-- style -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/assets/css/style.css') }}">
    <!-- responsive.css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('html_templates/fundme/assets/css/responsive.css') }}">
    @yield('styles')
</head>
...
<body>
                ...
                <div class="row">
                    <nav class="navbar">
                        ...
                        <div class="navbar-header">
                            <a class="navbar-brand" href="{{ route('home') }}">CURIOS</a>
                        </div>

                        <!-- Collect the nav links, forms, and other content for toggling -->
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right" style="margin-right: 0;">
                                <li><a href="index.html">Research Articles</a></li>
    ...
    <!-- js -->
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/jquery-2.1.4.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/bootstrap.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/owl.carousel.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/jquery.magnific-popup.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/waypoints.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/jquery.counterup.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/countdown.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/parallax.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/circle-progress.js') }}"></script>


    <!-- REVOLUTION JS FILES -->
    <script type="text/javascript" src="{{ asset('html_templates/fundme/rev-slider/js/jquery.themepunch.tools.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/rev-slider/js/jquery.themepunch.revolution.min.js') }}"></script>

    <!-- SLIDER REVOLUTION 5.0 EXTENSIONS (Load Extensions only on Local File Systems !
    The following part can be removed on Server for On Demand Loading) -->

    <script type="text/javascript" src="{{ asset('html_templates/fundme/rev-slider/js/revolution.extension.actions.min.js') }}"></script>
    
    <script type="text/javascript" src="{{ asset('html_templates/fundme/rev-slider/js/revolution.extension.layeranimation.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/rev-slider/js/revolution.extension.navigation.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/rev-slider/js/revolution.extension.parallax.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/rev-slider/js/revolution.extension.slideanims.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('html_templates/fundme/rev-slider/js/revolution.extension.video.min.js') }}"></script>



    <script type="text/javascript" src="{{ asset('html_templates/fundme/assets/js/function.js') }}"></script>
